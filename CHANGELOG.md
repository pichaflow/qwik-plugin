...
### Fixed
- Fixed Qwik compiler warnings for the upload drag-and-drop zone by adding appropriate ARIA roles (`role="button"`), `tabIndex="0"`, and keyboard handlers (`onKeyDown$`).
